                    ...
                    <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full ">
                      ...
                      <div class="overflow-y-auto overflow-x-hidden flex-grow">
                        ...
                        <ul class="flex flex-col py-4 space-y-1">
                          ...
                          <li>
                            <a href="/dashboard" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6">
...
{{--                          <li>--}}
{{--                            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6">--}}
{{--                              <span class="inline-flex justify-center items-center ml-4">--}}
...
{{--                          </li>--}}
                          ...
                          {{-- User Role 99= Admin, 2 = Employee --}}
                          @if(Auth::user()->role_id == 99 || Auth::user()->role_id == 2)
                          ...
                          <li>
                            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6
                            {{ request()->is('dashboard/manage/users') ? 'bg-gray-100 border-tas-500 text-gray-900 font-semibold' : '' }}
                            ">
                              <span class="inline-flex justify-center items-center ml-4">
                            ...
                            <li>
                                <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6
                                {{ request()->is('dashboard/manage/locations') ? 'bg-gray-100 border-tas-500 text-gray-900 font-semibold' : '' }}
                                ">
                                  <span class="inline-flex justify-center items-center ml-4">
                        ...
                        <li>
                            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6
                        {{ request()->is('dashboard/manage/appointments') ? 'bg-gray-100 border-tas-500 text-gray-900 font-semibold' : '' }}
                        ">
                          <span class="inline-flex justify-center items-center ml-4">
                          ...
                          <li>
                            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6
                            {{ request()->is('dashboard/manage/services') ? 'bg-gray-100 border-tas-500 text-gray-900 font-semibold' : '' }}
                            ">
                              <span class="inline-flex justify-center items-center ml-4">
                            ...
                            <li>
                                <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6
                        {{ request()->is('dashboard/manage/categories') ? 'bg-gray-100 border-tas-500 text-gray-900 font-semibold' : '' }}
                        ">
                          <span class="inline-flex justify-center items-center ml-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                          </span>
                          ...
                          <li>
                            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-tas-500 pr-6
                            {{ request()->is('dashboard/manage/deals') ? 'bg-gray-100 border-tas-500 text-gray-900 font-semibold' : '' }}
                            ">
                              <span class="inline-flex justify-center items-center ml-4">
