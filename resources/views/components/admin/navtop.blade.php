...
<header class="main-header">
    ...
    <a href="/" class="logo">
        ...
        <span class="logo-lg"><b>BackOffice</b> System</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
        <!-- Sidebar toggle button old-->
        <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
            <span class="sr-only">Toggle navigation</span>
        </a>
        <!--
    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul id="ul-topmenu" class="nav navbar-nav">
            <li><a href="/">Dashboard</a></li>
            <li><a href="#">Link</a></li>
            <li id='li-config' class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Config <span class="caret"></span></a>
