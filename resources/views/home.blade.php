<x-app-layout>
    ...
    <div class="relative">
        ...
        <section class="relative bg-cover bg-center bg-no-repeat " style="background-image: url({{asset('images/bg-img.jpg')}})" ;>
                  ...
                  <div class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
                    <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
                      ...
                      <strong class="block font-extrabold text-tas">Taman Air Spa</strong>
                      </h1>

                <p class="mt-4 max-w-lg sm:text-xl/relaxed">
                  Taman Air Spa received the Best Stand Alone Spa 2016 Award by the Indonesia Tourism Department.
                </p>

                <div class="mt-8 flex flex-wrap gap-4 text-center">
                  <a href="#" class="block w-full rounded bg-tas-gr px-12 py-3 text-lg font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring active:bg-red-600 sm:w-auto">Book Now</a>
            <a
                      href="#"
...
<!-- Footer container -->
<footer class="text-center text-neutral-100 lg:text-left">
<div
...
<div class="bg-white p-2 text-center">
  <span class="text-neutral-500">©<?php echo date("Y"); ?> Copyright:</span>
  <a class="font-semibold text-neutral-600" href="/">Taman Air Spa</a
  >
</div>
</footer>
</x-app-layout>